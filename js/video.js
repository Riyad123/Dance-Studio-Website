		...
		return this.each(function() {	
			...
			$(this)[0].addEventListener('loadedmetadata', function() {
				...
				$that.find('.play-pause').bind('click', function() {
					   $(".play-button").toggleClass("HidePlay");
				...
				$('body, html').bind('mousemove', function(e) {
					...
					if($begin == true) {
						$that.hover(function() {
                           ...
                           $that.find('.play-pause').stop(true, false).animate({'opacity' : '1'}, 0.5);
						}, function() {
							$that.find('.player').stop(true, false).animate({'opacity' : '1'}, 0.5);
                           $that.find('.play-pause').stop(true, false).animate({'opacity' : '0'}, 0.5);
